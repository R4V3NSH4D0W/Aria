...
export const Player: React.FC<PlayerProps> = ({
  ...
  return (
    <footer className="fixed bottom-6 left-6 right-6 h-24 bg-[#0e1015]/60 backdrop-blur-xl border border-white/10 rounded-2xl px-4 lg:px-6 flex items-center justify-between z-30 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] animate-player-slide-up gap-4">
      ...
      <div className="flex items-center gap-1.5 lg:gap-2.5 w-1/3 min-w-[80px] max-w-[240px] justify-end shrink-0">
        ...
        <div className="relative" ref={sleepMenuRef}>
          <button
            ...
            title="Sleep timer"
          >
            <Moon className={`w-4 h-4 lg:w-4.5 h-4.5 ${sleepTimerTimeLeft !== null || sleepAtTrackEnd ? "fill-current" : ""}`} />
            {(sleepTimerTimeLeft !== null || sleepAtTrackEnd) && (
        ...
        <button
          ...
          title="Mini Player"
        >
          <Minimize2 className="w-4 h-4 lg:w-4.5 h-4.5" />
        </button>
        ...
        <div className="relative flex items-center group/volume py-2">
          ...
          <div className="absolute bottom-full left-1/2 -translate-x-1/2 pb-2 opacity-0 scale-90 pointer-events-none group-hover/volume:opacity-100 group-hover/volume:scale-100 group-hover/volume:pointer-events-auto transition-all duration-200 z-50">
            <div className="w-10 h-36 bg-[#0e1015]/95 backdrop-blur-2xl border border-white/10 rounded-2xl p-3 flex flex-col items-center justify-between shadow-2xl">
              <div className="h-24 w-full flex items-center justify-center relative">
                <input
                  ...
                  className="absolute w-20 h-1 rounded-full appearance-none cursor-pointer outline-none -rotate-90 transition-all
                  [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#818cf8] [&::-webkit-slider-thumb]:shadow-[0_0_10px_rgba(99,102,241,0.8)]"
                />
              </div>
              <span className="text-[9px] font-mono text-slate-400 select-none shrink-0">
