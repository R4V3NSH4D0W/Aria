        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-5">
          {ytPlaylists.map((playlist) => (
            <div
              ...
              className="group relative bg-[#13161c] hover:bg-white/[0.04] border border-white/5 hover:border-white/10 p-4 rounded-2xl transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
              {/* Thumbnail Container */}
