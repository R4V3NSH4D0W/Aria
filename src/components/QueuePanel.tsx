        ...
        {queue.length === 0 ? (
          ...
          >
            ...
            <DragOverlay adjustScale={false}>
              {activeTrack ? (
                <div className="w-full flex items-center gap-3 p-2.5 rounded-xl border border-indigo-500/50 bg-[#12151b] text-white shadow-2xl scale-[1.02] opacity-90 select-none">
